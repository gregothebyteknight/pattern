...
coords = pd.read_csv("../data/cell_coordinates_clusters.csv", index_col = 0)
cell_type = 6

def select_cell(coords, cell_type):
    cell_coords = coords[coords['Clusters'] == cell_type]
    ...
    print("Mean by X coordinate:", cell_coords_center.ilocs[:, 0].mean())
